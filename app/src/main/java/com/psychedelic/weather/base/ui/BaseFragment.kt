...
import cn.wj.android.common.ui.fragment.CommonBaseBindingFragment
 ...
 * Fragment 基类
 */
abstract class BaseFragment<VM : BaseViewModel<V>, V : BaseView, DB : ViewDataBinding>
    : CommonBaseBindingFragment<VM, V, DB>(),
    BaseView {
